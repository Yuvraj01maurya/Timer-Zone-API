...
latLongFinder()
  .then((data) => {
    ...
    return fetch(
      `https://api.geoapify.com/v1/geocode/reverse?lat=${data.lat}&lon=${data.long}&format=json&apiKey=${apiKey}`
    );
  })
  .then((fetechedData) => {
      ...
      .then((data) => {
        ...
        resultDiv.innerHTML = `
                ...
                <tr>
                    ...
                    <td>${data.features[0].properties.timezone.offset_DST_seconds}</td>
                </tr>
                <tr>
                    <td>Country:</td>
